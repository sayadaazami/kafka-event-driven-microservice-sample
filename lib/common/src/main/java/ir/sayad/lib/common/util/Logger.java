...
public class Logger {
    ...
    public static void debug(String identifier, Object object) {
        log(0, String.format("(%s)-[%s]-{%s}->%s", getFileName(), getMethodName(), identifier, JsonUtil.toString(object)), null);
    }
    ...
    public static void info(String identifier, Object message) {
        log(1, String.format("(%s)-[%s]-{%s}->%s", getFileName(), getMethodName(), identifier, JsonUtil.toString(message)), null);
    }
    ...
    public static void error(String identifier, Object message) {
        log(2, String.format("(%s)-[%s]-{%s}->%s", getFileName(), getMethodName(), identifier, JsonUtil.toString(message)), null);
    }
